...
<body>
    <div class="banner">
        ...
        <img src="assets/images/background/spitfire-bannermain.jpg" alt="spitfire banner" style="display: block;" id="image1">
        <img src="assets/images/background/bundeswehr.jpg" alt="bundeswehr banner" style="display: none;" id="image2">
    </div>
    ...
    <div id="menu-items">
            <a class="item" href="index.html" style="text-decoration: underline;">Home</a>
...
<div class="card-row">
    <div class="card-top">
        <img src="assets/images/background/spitfire-img.jpg" alt="spitfire" id="background-img" style="width: 100%;">
        <div class="overlay">
    ...
    <div class="card-column">
        <div class="card-top">
        <img src="assets/images/background/Spitfire-hangar.jpg" alt="hangar" style="width: 100%; height: 100%;">
        <div class="overlay">
            <h2>Welcome to the history forum</h2>
            <a href="forum.html" class="link"><span style="color: yellow;">> </span>To the history forum</a>
        </div>
    </div>
        <div class="card-top">
        <img src="assets/images/background/merch.jpg" alt="merch" style="width: 100%;">
        <div class="overlay">
